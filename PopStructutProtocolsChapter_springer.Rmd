...
authors: 
- name: Chi-Chun Liu
  address: Department of Human Genetics, University of Chicago
  
- name: Suyash Shringapure
  address: Department of Genetics, University of Chicago
  
- name: Kenneth Lange Lange
  address: Departments of Biomathematics, Human Genetics, and Statistics. University of California, Los Angeles
  
- name: John Novembre
  address: Department of Human Genetics, Ecology and Evolution. University of Chicago
...
```{r, eval = TRUE, fig.height=1.5, fig.width=4.5}
library(RColorBrewer)
tbl <- read.table("out/H938_Euro.LDprune.8.Q")
par(mar = c(1, 4, 2, 2))
barplot(t(as.matrix(tbl)),
  col = brewer.pal(8, "Set1"), ylab = "Admixture Proportions",
  border = NA, space = 0
)
```
...
![Example PONG output](./plot/H938_Euro_LDprune_K8.png){ width=4.5inch}
...
![Visualizing multiple runs of ADMIXTURE](./plot/modes_K=6_2018-10-12_10h6m16s_pong.png){width=4.5inch}
With a lenient similarity threshold 0.9 between runs, we see ancestry components for Sardinian, North Italian, and French Basque are still different across multiple runs.
...
![Example PONG output](./plot/mainviz_2018-10-12_10h7m3s_pong.png){ width=4.5inch}
...
```{r, eval = TRUE, echo=TRUE, results='hide',warning=FALSE,message=FALSE, fig.height=10, fig.width=10, out.width = "100%"}
library(PCAviz)
library(cowplot)
...
```{r, eval = TRUE,fig.height=8,fig.width=8, out.width = "100%"}
...
```{r, eval = TRUE, fig.height=6, fig.width=8, out.width = "100%"}
for (i in 1:5) {
